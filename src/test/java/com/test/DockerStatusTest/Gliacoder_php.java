...
public class Gliacoder_php {
    ...
    public void Php_Status() {
        ...
        String containerId = "e51ddc8f7fb2";

        System.out.println("Gliacoder php Docker ID = " + containerId);
        ...
        try {
            ...
            if (!isRunning) {
                sendEmailAlert("Hi,\n\n🚨 This is Gliacoder php Docker. I am currently down. Kindly restart the container at your earliest convenience.");
